...
- (GDFileType)fileType {
    ...
    } else if ([self.fileName.lowercaseString rangeOfString:@".jpg"].location != NSNotFound || [self.fileName.lowercaseString rangeOfString:@".png"].location != NSNotFound) {
        return GDFileTypeImage;
    } else {
...
- (NSString *)imageNameForFileType:(GDFileType)fileType {
    NSString *imageName;
    switch (fileType) {
        case GDFileTypeFolder: imageName = @"gd_folder"; break;
        case GDFileTypePdf: imageName = @"gd_page_white_acrobat"; break;
        case GDFileTypeDoc: case GDFileTypeDocx: imageName = @"gd_page_white_word"; break;
        case GDFileTypeRtf: case GDFileTypeTxt: imageName = @"gd_page_white_text"; break;
        default: imageName = @"gd_page_white"; break;
    }
