...
- (BOOL)isFolder {
    ...
    if (self.provider == GDCloudProviderDropbox) {
        DBMetadata *fileInfo = (DBMetadata *)self.file;
...
#pragma mark - Private
- (void)processDropboxFile:(DBMetadata *)fileInfo {
    self.fileName = [fileInfo filename];
    self.lastModifiedDate = [fileInfo lastModifiedDate];
    self.size = [fileInfo totalBytes];
